...
## Solución
```
DanielMtzC-picoctf@webshell:~$ wget https://artifacts.picoctf.net/c/1/code.py
--2025-09-09 19:02:33--  https://artifacts.picoctf.net/c/1/code.py
DanielMtzC-picoctf@webshell:~$ ls
README.txt  code.py  codebook.txt
DanielMtzC-picoctf@webshell:~$ python3 code.py 
picoCTF{c0d3b00k_455157_d9aa2df2}


PYTHON CODE
DanielMtzC-picoctf@webshell:~$ cat code.py 
